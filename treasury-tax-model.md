...
## **2. Methodology: How We Model the Impact of the Tax Cut**

### **2.1 Treasury Sustainability**
The Treasury receives a portion of transaction fees from Cardano network activity. We project treasury growth under both **20% and 10% tax rates**, using:
...
A tax cut returns more ADA to the staking economy, **boosting staking yields** and attracting more participation. We model:
...
A lower tax rate **reduces friction for DeFi participants** and encourages capital allocation to liquidity pools, benefiting Cardano’s stablecoin ecosystem. We model:
...
The Treasury depends on transaction fees, and economic activity influences **how much revenue the network generates**. We model:
...
Chris O argues that the Treasury tax should not be reduced due to potential risks. Below, we address each of his concerns with **data-backed counterarguments**.
...
**Chris O’s claim:** The 20% tax was designed to rapidly build the Treasury and is a key anchor of ADA’s monetary policy. Adjusting this could destabilize the system.
...
**Counterpoint:**
- We have built predictive models. Our 5-year simulations **show Treasury growth remains stable** under a 10% tax, while **staking participation, DeFi TVL, and network activity increase.**
...
**Key Takeaway:**  
Predictive modeling already shows the Treasury remains stable at 10%, and governance can adjust if needed. The risk of not evolving is greater than the risk of careful, data-driven change.
...
Unlike other funding models, this approach assumes **starting from zero** and directing 10% of transaction fees (historically estimated at ~400K ADA per year) into the fund.
- **Baseline Growth:** A steady **5% annual yield** from conservative investments such as ADA staking or ecosystem bonds.
- **Reinvestment Strategy:** **50% of fund-generated yield reinvested** into compounding growth.
- **Annual Treasury Inflow:** A fraction of Cardano’s **transaction fees and governance-set allocations** continuously funds the reserve.

![Projected Growth of Sovereign Wealth Fund](images/sovereign_fund_growth.png)

This projection shows how even **with a zero starting balance**, the sovereign wealth fund **compounds over 10 years** into a significant reserve. This ensures **long-term sustainability without requiring additional governance votes** each year to fund new initiatives.

## **5. Why This Governance Action Should Focus Only on the Tax Cut**
